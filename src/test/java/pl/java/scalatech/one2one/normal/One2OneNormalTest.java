package pl.java.scalatech.one2one.normal;
...
import pl.java.scalatech.domain.oneToOne.normal.EmailMessage;



@Slf4j
@FixMethodOrder(NAME_ASCENDING)
public class One2OneNormalTest extends ORMStandaloneClassTestCase{
    @Test
