...
@EntityScan(basePackages = "pl.java.scalatech.domain.mapkey.entityExample")
@EnableJpaRepositories(basePackages = "pl.java.scalatech.repository.map.entityExample")
