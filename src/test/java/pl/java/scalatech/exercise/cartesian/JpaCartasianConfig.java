...
@EntityScan(basePackages = "pl.java.scalatech.domain.cartesian")
@EnableJpaRepositories(basePackages = "pl.java.scalatech.repository.cartesian")
...
public class JpaCartasianConfig {
