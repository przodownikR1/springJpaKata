...
@EntityScan(basePackages = "pl.java.scalatech.domain.inheritence.joined")
@EnableJpaRepositories(basePackages = "pl.java.scalatech.repository.inheritence.joined")
...
@Profile("joined")
@Configuration
public class JoinedTableConfig {
