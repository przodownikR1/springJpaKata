...
NOTE: Gdy wartość jest typem prostym lub klasą zagnieżdzoną , dodajemy @ElementCollection

WARNING: Map działa tylko po jednej stronie relacji dwukierunkowej
